...
class Plot:
    ...
    def ShowHierarchicalClusterings(self,ranked_ensemble,mxRMSD,rms_cutoff,name='HierClustPlt',save=False,cluster_index=False):
        """
    ...
    def ShowGeneralMatrix(self,mxGen,file_name='HeatMap',save=False,range=(0,1),cmap=plt.cm.Blues):
        """
