...
'''
    ...
    def RMSD_from_same_structure(self, otherStruct, CA=False):
        """
    ...
    def break_into_segments(self, rigid_list): 
        """
        ...
        structList = []
        for r in rigid_list:
            fstStruct = self.get_selection(r[0], r[1])
            nxtStructs = []
            for x in range(2, len(r), 2):
                nxtStructs.append(self.get_selection(r[x], r[x+1]))
            #print nxtStructs
            if len(nxtStructs) != 0:
